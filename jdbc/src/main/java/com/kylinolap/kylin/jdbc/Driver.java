 ...
 * 
 * <pre>
 * Driver driver = (Driver) Class.forName(&quot;com.kylinolap.kylin.jdbc.Driver&quot;)
 * 		.newInstance();
...
public class Driver extends UnregisteredDriver {
	...
	protected DriverVersion createDriverVersion() {
		return DriverVersion.load(Driver.class,
				"com-kylinolap-kylin-jdbc.properties", "Kylin JDBC Driver",
	...
	protected Handler createHandler() {
		return new HandlerImpl() {
			...
			public void onConnectionInit(AvaticaConnection connection_)
				...
				RemoteClient runner = ((KylinJdbc41Factory) factory)
						.newRemoteClient(kylinConn);
				try {
					runner.connect();
					kylinConn.setMetaProject(runner.getMetadata(kylinConn
							.getProject()));
