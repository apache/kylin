...
public class StreamCubeJoinedFlatTableDesc implements IJoinedFlatTableDesc, Serializable {
    ...
    public StreamCubeJoinedFlatTableDesc(CubeDesc cubeDesc, CubeSegment cubeSegment, IJoinedFlatTableDesc flatTableDesc) {
    ...
    public StreamCubeJoinedFlatTableDesc(CubeSegment cubeSegment, IJoinedFlatTableDesc flatTableDesc) {
        this(cubeSegment.getCubeDesc(), cubeSegment, flatTableDesc);
    }
