...
KylinApp.factory('CubeService', ['$resource', function ($resource, config) {
  ...
  return $resource(Config.service.url + 'cubes/:cubeId/:propName/:propValue/:action', {}, {
    ...
    updateNotifyEmailList: {method: 'PUT', params: {propName: 'notify_email_list'}, isArray: false},
    updateNotifyDingTalkList: {method: 'PUT', params: {propName: 'notify_dingtalk_list'}, isArray: false},
