export default {
  en: {
    ...
    disableModelStorageSettingTip: 'Can\'t change the storage type. The storage type can only be changed when the model data is empty and has no running build jobs.',
