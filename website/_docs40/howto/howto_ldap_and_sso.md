...
categories: howto
permalink: /docs40/howto/howto_ldap_and_sso.html
---
...
From v1.5, Kylin provides SSO with SAML. The implementation is based on Spring Security SAML Extension. You can read [this reference](http://docs.spring.io/autorepo/docs40/spring-security-saml/1.0.x-SNAPSHOT/reference/htmlsingle/) to get an overall understand.
