...
public class NDCuboidMapperTest extends LocalFileMetadataTestCase {
    ...
    public void testMapReduceWithSlr() throws IOException {
        ...
        byte[] value =
                {14, 7, 23, -16, 56, 92, 114, -80, 118, 14, 7, 23, -16, 56, 92, 114, -80, 118, 14, 7, 23,
                        -16, 56, 92, 114, -80, 118, 1};
        ...
        byte[] resultKey =
                {0, 0, 0, 0, 0, 0, 1, 127, 49, 48, 48, 48, 48, 48, 48, 48, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 55,
                        13, 71, 114, 65, 66, 73, 78, 9, 9, 9, 9, 9, 9, 9, 9, 0, 10, 0};
        byte[] resultValue =
                {14, 7, 23, -16, 56, 92, 114, -80, 118, 14, 7, 23, -16, 56, 92, 114, -80, 118, 14, 7, 23,
                        -16, 56, 92, 114, -80, 118, 1};
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            System.arraycopy(result.get(i).getFirst().getBytes(), 0, bytes, 0, result.get(i).getFirst()
                    .getLength());
