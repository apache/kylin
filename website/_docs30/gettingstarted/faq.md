...
　2. Browse Kylin's official website, especially the [docs30 page](http://kylin.apache.org/docs30/) and the [FAQ page](http://kylin.apache.org/docs30/gettingstarted/faq.html). 
...
#### How to export/import cube/project across different Kylin environments?
  ...
  * Please check: [http://kylin.apache.org/docs30/howto/howto_use_cli.html](http://kylin.apache.org/docs30/howto/howto_use_cli.html)
