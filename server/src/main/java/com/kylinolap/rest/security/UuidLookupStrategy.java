...
public class UuidLookupStrategy implements LookupStrategy {
    ...
    private final static String DEFAULT_LOOKUP_IDENTITIES_WHERE_CLAUSE =
    ...
    private String computeRepeatingSql(String repeatingSql, int requiredRepetitions) {
        ...
        StringBuilder sqlStringBldr =
                new StringBuilder(startSql.length() + endSql.length() + requiredRepetitions
    ...
    private AclImpl convert(Map<Serializable, Acl> inputMap, Long currentIdentity) {
        ...
        AclImpl result =
                new AclImpl(inputAcl.getObjectIdentity(), (Long) inputAcl.getId(), aclAuthorizationStrategy,
        ...
        private void convertCurrentResultIntoObject(Map<Serializable, Acl> acls, ResultSet rs)
            ...
            if (acl == null) {
                ...
                ObjectIdentity objectIdentity =
                        new ObjectIdentityImpl(rs.getString("class"), rs.getString("object_id_identity"));
                ...
                acl =
                        new AclImpl(objectIdentity, id, aclAuthorizationStrategy, grantingStrategy,
                                parentAcl, null, entriesInheriting, owner);
            ...
            if (rs.getString("ace_sid") != null) {
                ...
                AccessControlEntryImpl ace =
                        new AccessControlEntryImpl(aceId, acl, recipient, permission, granting, auditSuccess,
                                auditFailure);
    ...
    private class StubAclParent implements Acl {
        private static final long serialVersionUID = 7010778091881420017L;
