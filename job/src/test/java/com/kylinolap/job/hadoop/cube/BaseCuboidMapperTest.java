...
public class BaseCuboidMapperTest extends LocalFileMetadataTestCase {
	...
	public void testMapperWithHeader() throws Exception {
		...
		decoder.decode(key);
		assertEquals(
				"[123456789, 2012-12-15, 11848, Health & Beauty, Fragrances, Women, Auction, 0, 15]",
		...
		verifyMeasures(cube.getDescriptor().getMeasures(), result.get(0)
				.getSecond(), "132.33", "132.33", "132.33", 1);
	}

	private void verifyMeasures(List<MeasureDesc> measures, Text valueBytes,
			String m1, String m2, String m3, long m4) {
	...
	public void testMapperWithNull() throws Exception {
		...
		decoder.decode(key);
		assertEquals(
				"[123456789, 2012-12-15, 11848, Health & Beauty, Fragrances, null, Auction, 0, 15]",
				decoder.getValues().toString());
