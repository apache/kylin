export default {
  'en': {
    ...
    isDel_auto_merge_time_ranges: 'Are you sure delete auto-merge Parameter Configuration?',
    isDel_volatile_range: 'Are you sure delete volatile range Parameter Configuration?',
    isDel_retention_range: 'Are you sure you want to delete the "Retention Threshold" configuration?',
