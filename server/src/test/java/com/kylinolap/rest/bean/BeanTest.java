...
public class BeanTest {
	...
	public void test() {
		try {
			...
			BeanValidator.validateAccssor(SelectedColumnMeta.class,
					new String[0]);
			...
			BeanValidator.validateAccssor(AccessEntryResponse.class,
					new String[0]);
		...
		SelectedColumnMeta coulmnMeta = new SelectedColumnMeta(false, false,
				false, false, 0, false, 0, null, null, null, null, null, 0, 0,
		...
		Assert.assertEquals(Constant.ACCESS_HAS_ROLE_ADMIN,
				"hasRole('ROLE_ADMIN')");
		Assert.assertEquals(
