 ...
 * @author yangli9
 */
public class AggregationFilter implements RegionScanner {

    private RegionScanner outerScanner;

    public AggregationFilter(Cuboid cuboid, RowFilter filter, RowProjector groupBy, RowAggregators aggrs,
        ...
        aggCache = buildAggrCache(innerScanner, groupBy, aggrs, filter, stats);
    ...
    AggregationCache buildAggrCache(final RegionScanner innerScanner, RowProjector projector,
                                    RowAggregators aggregators, RowFilter filter, Stats stats) throws IOException {
