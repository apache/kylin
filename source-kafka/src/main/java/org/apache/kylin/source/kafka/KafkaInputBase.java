...
import org.apache.kylin.cube.model.StreamCubeJoinedFlatTableDesc;
...
public class KafkaInputBase {
    ...
    public static class BaseBatchCubingInputSide implements IInput.IBatchCubingInputSide {
        ...
        public void addStepPhase1_CreateFlatTable(DefaultChainedExecutable jobFlow) {
            ...
            if (onlyOneTable) {
                ...
                final StreamCubeJoinedFlatTableDesc streamFlatDesc = new StreamCubeJoinedFlatTableDesc(cubeDesc, seg, flatDesc);
                jobFlow.addTask(createSaveKafkaDataStep(jobFlow.getId(), baseLocation + "/" + streamFlatDesc.getTableName(), seg));
                jobFlow.addTask(createFlatTable(hiveTableDatabase, baseLocation, cubeName,
                        streamFlatDesc, intermediateTables, intermediatePaths));
            }
        }
    ...
    protected static AbstractExecutable createFlatTable(final String hiveTableDatabase,
            ...
            final StreamCubeJoinedFlatTableDesc streamFactDesc, final List<String> intermediateTables,
