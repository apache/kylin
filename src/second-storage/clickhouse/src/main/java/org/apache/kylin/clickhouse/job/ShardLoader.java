...
package org.apache.kylin.clickhouse.job;

import org.apache.kylin.clickhouse.database.ClickHouseOperator;
import org.apache.kylin.clickhouse.ddl.ClickHouseCreateTable;
import org.apache.kylin.clickhouse.ddl.ClickHouseRender;
import org.apache.kylin.metadata.cube.model.LayoutEntity;
import org.apache.kylin.secondstorage.NameUtil;
...
import org.apache.kylin.secondstorage.ddl.exp.ColumnWithAlias;
...
public class ShardLoader {
    ...
    private void commitIncrementalLoad() throws SQLException {
        ...
        Select queryPartition = new Select(TableIdentifier.table(database, insertTempTableName))
                .column(ColumnWithAlias.builder().name(DataLoader.getPrefixColumn(partitionColumn)).distinct(true).build());
    ...
    private void createTable(String table, LayoutEntity layout, String partitionBy, boolean addPrefix)
        ...
        final ClickHouseCreateTable mergeTable = ClickHouseCreateTable.createCKTable(database, table)
                .columns(DataLoader.columns(layout, partitionBy, addPrefix))
                .partitionBy(addPrefix && partitionBy != null ? DataLoader.getPrefixColumn(partitionBy) : partitionBy)
