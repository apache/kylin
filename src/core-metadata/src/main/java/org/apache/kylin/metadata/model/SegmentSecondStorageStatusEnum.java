...
public enum SegmentSecondStorageStatusEnum implements Serializable {
    ...
    static {
        Arrays.stream(SegmentSecondStorageStatusEnum.values()).forEach(value -> nameMap.put(value.toString(), value));
    }

    public static SegmentSecondStorageStatusEnum getByName(String name) {
