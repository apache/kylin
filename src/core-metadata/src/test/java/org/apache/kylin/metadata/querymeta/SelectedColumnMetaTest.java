...
public class SelectedColumnMetaTest extends NLocalFileMetadataTestCase {
    ...
    public void testGetDisplaySize() {
        SelectedColumnMeta selectedColumnMeta = new SelectedColumnMeta(false, false, false, false, 1, true, 20, null,
                null, null, null, null, 20, 100, 12, "varchar", false, false, false);

        SelectedColumnMeta selectedColumnMeta0 = new SelectedColumnMeta(false, false, false, false, 1, true, 25, null,
                null, null, null, null, 25, 100, 1, "char", false, false, false);
