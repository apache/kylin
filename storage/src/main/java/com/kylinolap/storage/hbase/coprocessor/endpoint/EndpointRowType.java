 ...
 * @author honma
 */
public class EndpointRowType {

    public static EndpointRowType fromCuboid(CubeSegment seg, Cuboid cuboid) {
        ...
        return new EndpointRowType(cols, colSizes);
    }

    public static byte[] serialize(EndpointRowType o) {
    ...
    public static EndpointRowType deserialize(byte[] bytes) {
        return serializer.deserialize(ByteBuffer.wrap(bytes));
    }

    private static final Serializer serializer = new Serializer();

    private static class Serializer implements BytesSerializer<EndpointRowType> {

        @Override
        public void serialize(EndpointRowType o, ByteBuffer out) {
        ...
        @Override
        public EndpointRowType deserialize(ByteBuffer in) {
    ...
    public EndpointRowType(TblColRef[] columns, int[] columnSizes) {
