 ...
 *  Indicate this method is a transaction may break in intermediate state and has no guarantee of roll back succeed.
 *  That is to say, it maybe break in some situation and need have a manual repair.
 *  It is a warning and not user friendly.
 *
 *  For the worst situation, ClusterDoctor should be fix it as a manual repair way.
 * </pre>
 *
