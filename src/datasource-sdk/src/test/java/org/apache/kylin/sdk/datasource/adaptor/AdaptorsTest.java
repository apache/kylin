...
public class AdaptorsTest extends JdbcConnectorTest {
    ...
    public void testMySQLAdaptor() throws Exception {
        getTestConfig().setProperty("kylin.source.jdbc.adaptor",
                "org.apache.kylin.sdk.datasource.adaptor.MysqlAdaptor");
    ...
    public void testMssqlAdaptor() throws SQLException {
        getTestConfig().setProperty("kylin.source.jdbc.adaptor",
                "org.apache.kylin.sdk.datasource.adaptor.MssqlAdaptor");
    ...
    public void testSQLDWAdaptor() throws SQLException {
        getTestConfig().setProperty("kylin.source.jdbc.adaptor",
                "org.apache.kylin.sdk.datasource.adaptor.SQLDWAdaptor");
