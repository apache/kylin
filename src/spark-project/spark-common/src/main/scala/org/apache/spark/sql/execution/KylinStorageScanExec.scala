...
case class KylinStorageScanExec(@transient relation: HadoopFsRelation,
  ...
  private def filterUnusedDynamicPruningExpressions(predicates: Seq[Expression]): Seq[Expression] = {
