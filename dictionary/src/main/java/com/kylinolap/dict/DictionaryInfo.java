...
public class DictionaryInfo extends RootPersistentEntity {
	...
	public DictionaryInfo(String sourceTable, String sourceColumn,
			int sourceColumnIndex, String dataType, TableSignature input,
	...
	public String getResourcePath() {
		return ResourceStore.DICT_RESOURCE_ROOT + "/" + sourceTable + "/"
				+ sourceColumn + "/" + uuid + ".dict";
	}
