...
categories: install
permalink: /docs26/install/configuration.html
---
...
- `kylin.storage.limit-push-down-enable`: the default value is *TRUE*, set to *FALSE* to close the limit-pushdown of storage layer
