...
public class DataTypeOrderTest {
    ...
    void testDataTypeOrder() {
        ...
        Assertions.assertEquals("2000000", dataTypeOrder.max(integers));
        Assertions.assertEquals("-10000", dataTypeOrder.min(integers));
        ...
        Set<String> doubels = Sets.newHashSet("1.1", "-299.5", "100000", "1.000", "4.000000001", "0.00", "-1000000.231231", "8000000",
                "10", "10.00");
        Assertions.assertEquals("8000000", dataTypeOrder.max(doubels));
        Assertions.assertEquals("-1000000.231231", dataTypeOrder.min(doubels));
        ...
        Assertions.assertEquals("2888-08-09", dataTypeOrder.max(datetimes));
        Assertions.assertEquals("1970-01-19 00:18:32", dataTypeOrder.min(datetimes));
        ...
        Set<String> strings = Sets.newHashSet(null, "", "中国", "China No.1", "神兽麒麟", "Rocket", "Apache Kylin", "google", "NULL",
                "empty");
        Assertions.assertEquals("神兽麒麟", dataTypeOrder.max(strings));
        Assertions.assertEquals("", dataTypeOrder.min(strings));
    }
}
