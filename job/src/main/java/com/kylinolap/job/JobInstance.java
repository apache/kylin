...
public class JobInstance extends RootPersistentEntity {
	...
	public static String getStepIdentity(JobInstance jobInstance,
			JobStep jobStep) {
	...
	public JobStatusEnum getStatus() {
		...
		} else if (compositResult == (JobStatusEnum.FINISHED.getCode() | JobStatusEnum.PENDING
				.getCode())) {
			return JobStatusEnum.PENDING;
		} else if ((compositResult & JobStatusEnum.ERROR.getCode()) == JobStatusEnum.ERROR
				.getCode()) {
			return JobStatusEnum.ERROR;
		} else if ((compositResult & JobStatusEnum.DISCARDED.getCode()) == JobStatusEnum.DISCARDED
				.getCode()) {
			return JobStatusEnum.DISCARDED;
		} else if ((compositResult & JobStatusEnum.RUNNING.getCode()) == JobStatusEnum.RUNNING
				.getCode()) {
