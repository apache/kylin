...
class AppStatusContext(sparkContext: SparkContext, kylinConfig: KylinConfig) extends Logging {
 ...
 * ------------------------------------------------------------------------------------- */
  ...
  try {
    ...
    case NonFatal(e) =>
      logError("Error initializing AppStatusContext.", e)
  }
  ...
  def stop(): Unit = {
    ...
    logInfo("Stop AppStatusContext succeed.")
  }
}
