...
public class OLAPLimitRel extends SingleRel implements OLAPRel, EnumerableRel {
	...
	public OLAPLimitRel(RelOptCluster cluster, RelTraitSet traitSet,
	...
	public OLAPLimitRel copy(RelTraitSet traitSet, List<RelNode> inputs) {
		return new OLAPLimitRel(getCluster(), traitSet, sole(inputs),
				localOffset, localFetch);
	}
	...
	public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
		...
		EnumerableLimitRel enumLimit = new EnumerableLimitRel(getCluster(),
