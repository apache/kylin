...
public class HFileOutputFormat3
    ...
    createRecordWriter(final TaskAttemptContext context)
        ...
        FileOutputCommitter committer = (FileOutputCommitter) ReflectionUtils.newInstance(conf.getClass(
                "mapreduce.output.committer.class", FileOutputCommitter.class,
                org.apache.hadoop.mapreduce.OutputCommitter.class), outputPath, context);
