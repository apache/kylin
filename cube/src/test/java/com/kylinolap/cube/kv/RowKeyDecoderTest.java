...
public class RowKeyDecoderTest extends LocalFileMetadataTestCase {
    ...
    public void testDecodeWithoutSlr() throws Exception {
        ...
        assertEquals(
                ...
                names.toString());
        assertEquals("[2012-12-15, 11848, Health & Beauty, Fragrances, Women, FP-GTC, 0, 15]",
                values.toString());
    ...
    public void testEncodeAndDecodeWithUtf8() throws IOException {
        ...
        AbstractRowKeyEncoder rowKeyEncoder =
                AbstractRowKeyEncoder.createInstance(cube.getFirstSegment(), baseCuboid);
        ...
        assertEquals(
                "[CAL_DT, LEAF_CATEG_ID, META_CATEG_NAME, CATEG_LVL2_NAME, CATEG_LVL3_NAME, LSTG_FORMAT_NAME, LSTG_SITE_ID, SLR_SEGMENT_CD]",
                names.toString());
        assertEquals("[2012-12-15, 11848, Health & Beauty, Fragrances, Women, 刊登格式, 0, 15]",
                values.toString());
    }
}
