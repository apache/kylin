...
　2. Browse Kylin's official website, especially the [Docs page](http://kylin.apache.org/docs30/) and the [FAQ page](http://kylin.apache.org/docs30/gettingstarted/faq.html). 
