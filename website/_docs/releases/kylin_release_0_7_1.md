---
layout: docs
title:  Kylin (incubating) Release 0.7.1 - First Apache Release
categories: releases
permalink: /docs/releases/kylin_release_0_7_1.html
---
...
* JDBC driver available for client to interactive with Kylin server
* Binary package available download 
...
* [KYLIN-540] - Data model upgrade for legacy cube descriptions
...
* [KYLIN-517] - Always delete the last one of Add Lookup page button even if deleting the first join condition
...
* [KYLIN-571] - Dimensions lost when creating cube though JSON Editor
