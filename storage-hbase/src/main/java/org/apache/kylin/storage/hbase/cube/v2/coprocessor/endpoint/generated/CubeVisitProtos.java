...
public final class CubeVisitProtos {
  ...
  public interface CubeVisitRequestOrBuilder
     ...
     */
    java.util.List<CubeVisitRequest.IntList>
     ...
     * <code>repeated .CubeVisitRequest.IntList hbaseColumnsToGT = 4;</code>
     */
    java.util.List<? extends CubeVisitRequest.IntListOrBuilder>
  ...
  public static final class CubeVisitRequest extends
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
                hbaseColumnsToGT_ = new java.util.ArrayList<IntList>();
    ...
    public static final class IntList extends
            ...
            switch (tag) {
              ...
              case 8: {
                if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                  ints_ = new java.util.ArrayList<Integer>();
      ...
      private java.util.List<Integer> ints_;
      /**
       * <code>repeated int32 ints = 1;</code>
       */
      ...
      public static final class Builder extends
        ...
        // repeated int32 ints = 1;
        private java.util.List<Integer> ints_ = java.util.Collections.emptyList();
        private void ensureIntsIsMutable() {
          if (!((bitField0_ & 0x00000001) == 0x00000001)) {
            ints_ = new java.util.ArrayList<Integer>(ints_);
            bitField0_ |= 0x00000001;
           }
        }
        /**
    ...
    private java.util.List<IntList> hbaseColumnsToGT_;
    /**
     * <code>repeated .CubeVisitRequest.IntList hbaseColumnsToGT = 4;</code>
     */
    public java.util.List<IntList> getHbaseColumnsToGTList() {
      return hbaseColumnsToGT_;
    }
    /**
     * <code>repeated .CubeVisitRequest.IntList hbaseColumnsToGT = 4;</code>
     */
    public java.util.List<? extends IntListOrBuilder>
        getHbaseColumnsToGTOrBuilderList() {
      return hbaseColumnsToGT_;
    }
    /**
  ...
  bitField0_ |= 0x00000002;
      ...
      private void ensureHbaseColumnsToGTIsMutable() {
        if (!((bitField0_ & 0x00000008) == 0x00000008)) {
          hbaseColumnsToGT_ = new java.util.ArrayList<IntList>(hbaseColumnsToGT_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          IntList, IntList.Builder, IntListOrBuilder> hbaseColumnsToGTBuilder_;
      ...
      public Builder addAllHbaseColumnsToGT(
          Iterable<? extends IntList> values) {
        if (hbaseColumnsToGTBuilder_ == null) {
          ensureHbaseColumnsToGTIsMutable();
       ...
       * <code>repeated .CubeVisitRequest.IntList hbaseColumnsToGT = 4;</code>
       */
      public java.util.List<IntList.Builder>
  ...
  public static final class CubeVisitResponse extends
    ...
    public interface StatsOrBuilder
      ...
      // optional int64 compressionTimeCost = 13;
      /**
       * <code>optional int64 compressionTimeCost = 13;</code>
       */
      boolean hasCompressionTimeCost();
      /**
       * <code>optional int64 compressionTimeCost = 13;</code>
       */
      long getCompressionTimeCost();
    }
    /**
    ...
    public static final class Stats extends
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 104: {
                ...
                compressionTimeCost_ = input.readInt64();
                break;
              }
            }
          }
      ...
      // optional int64 compressionTimeCost = 13;
      public static final int COMPRESSIONTIMECOST_FIELD_NUMBER = 13;
      private long compressionTimeCost_;
      /**
       * <code>optional int64 compressionTimeCost = 13;</code>
       */
      public boolean hasCompressionTimeCost() {
        return ((bitField0_ & 0x00001000) == 0x00001000);
      }
      /**
       * <code>optional int64 compressionTimeCost = 13;</code>
       */
      public long getCompressionTimeCost() {
        return compressionTimeCost_;
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (((bitField0_ & 0x00001000) == 0x00001000)) {
          output.writeInt64(13, compressionTimeCost_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00001000) == 0x00001000)) {
          size += com.google.protobuf.CodedOutputStream
            .computeInt64Size(13, compressionTimeCost_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSerializedSize = size;
        return size;
      ...
      public boolean equals(final Object obj) {
        ...
        result = result && (hasCompressionTimeCost() == other.hasCompressionTimeCost());
        if (hasCompressionTimeCost()) {
          result = result && (getCompressionTimeCost()
              == other.getCompressionTimeCost());
        }
        result = result &&
            getUnknownFields().equals(other.getUnknownFields());
        return result;
      ...
      public int hashCode() {
        ...
        if (hasCompressionTimeCost()) {
          hash = (37 * hash) + COMPRESSIONTIMECOST_FIELD_NUMBER;
          hash = (53 * hash) + hashLong(getCompressionTimeCost());
        }
        hash = (29 * hash) + getUnknownFields().hashCode();
        memoizedHashCode = hash;
        return hash;
      ...
      public static final class Builder extends
        ...
        public org.apache.kylin.storage.hbase.cube.v2.coprocessor.endpoint.generated.CubeVisitProtos.CubeVisitResponse.Stats buildPartial() {
          ...
          result.compressionTimeCost_ = compressionTimeCost_;
          result.bitField0_ = to_bitField0_;
          onBuilt();
          return result;
        }
        ...
        public Builder mergeFrom(org.apache.kylin.storage.hbase.cube.v2.coprocessor.endpoint.generated.CubeVisitProtos.CubeVisitResponse.Stats other) {
          ...
          if (other.hasCompressionTimeCost()) {
            setCompressionTimeCost(other.getCompressionTimeCost());
          }
          this.mergeUnknownFields(other.getUnknownFields());
          return this;
        }
  ...
  bitField0_ |= 0x00000100;
         ...
         * <code>optional int64 compressionTimeCost = 13;</code>
         */
        public Builder setCompressionTimeCost(long value) {
          bitField0_ |= 0x00001000;
          compressionTimeCost_ = value;
          onChanged();
          return this;
        }
        /**
         * <code>optional int64 compressionTimeCost = 13;</code>
         */
        public Builder clearCompressionTimeCost() {
          bitField0_ = (bitField0_ & ~0x00001000);
          compressionTimeCost_ = 0L;
          onChanged();
          return this;
  ...
  bitField0_ |= 0x00000001;
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ErrorInfo, ErrorInfo.Builder, ErrorInfoOrBuilder> errorInfoBuilder_;
      /**
       * <code>optional .CubeVisitResponse.ErrorInfo errorInfo = 3;</code>
       *
       * <pre>
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          ErrorInfo, ErrorInfo.Builder, ErrorInfoOrBuilder>
          getErrorInfoFieldBuilder() {
        if (errorInfoBuilder_ == null) {
  ...
  public static abstract class CubeVisitService
    ...
    public interface Interface {
      ...
      public abstract void visitCube(
              ...
              com.google.protobuf.RpcCallback<CubeVisitResponse> done);
  ...
  static {
    String[] descriptorData = {
      ...
      "xScanBytes\030\010 \001(\003\022\037\n\020isExactAggregate\030\t \001" +
      "(\010:\005false\032\027\n\007IntList\022\014\n\004ints\030\001 \003(\005\"\342\004\n\021C" +
      "ubeVisitResponse\022\026\n\016compressedRows\030\001 \002(\014" +
      "\022\'\n\005stats\030\002 \002(\0132\030.CubeVisitResponse.Stat",
      "s\022/\n\terrorInfo\030\003 \001(\0132\034.CubeVisitResponse" +
      ".ErrorInfo\032\307\002\n\005Stats\022\030\n\020serviceStartTime" +
      "\030\001 \001(\003\022\026\n\016serviceEndTime\030\002 \001(\003\022\027\n\017scanne" +
      "dRowCount\030\003 \001(\003\022\032\n\022aggregatedRowCount\030\004 " +
      "\001(\003\022\025\n\rsystemCpuLoad\030\005 \001(\001\022\036\n\026freePhysic" +
      "alMemorySize\030\006 \001(\001\022\031\n\021freeSwapSpaceSize\030" +
      "\007 \001(\001\022\020\n\010hostname\030\010 \001(\t\022\016\n\006etcMsg\030\t \001(\t\022" +
      "\026\n\016normalComplete\030\n \001(\005\022\024\n\014scannedBytes\030" +
      "\013 \001(\003\022\030\n\020filteredRowCount\030\014 \001(\003\022\033\n\023compr" +
      "essionTimeCost\030\r \001(\003\032H\n\tErrorInfo\022*\n\004typ",
      "e\030\001 \002(\0162\034.CubeVisitResponse.ErrorType\022\017\n" +
      "\007message\030\002 \002(\t\"G\n\tErrorType\022\020\n\014UNKNOWN_T" +
      "YPE\020\000\022\013\n\007TIMEOUT\020\001\022\033\n\027RESOURCE_LIMIT_EXC" +
      "EEDED\020\0022F\n\020CubeVisitService\0222\n\tvisitCube" +
      "\022\021.CubeVisitRequest\032\022.CubeVisitResponseB" +
      "`\nEorg.apache.kylin.storage.hbase.cube.v" +
      "2.coprocessor.endpoint.generatedB\017CubeVi" +
      "sitProtosH\001\210\001\001\240\001\001"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_CubeVisitRequest_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_CubeVisitRequest_descriptor,
              new String[] { "GtScanRequest", "HbaseRawScan", "RowkeyPreambleSize", "HbaseColumnsToGT", "KylinProperties", "QueryId", "SpillEnabled", "MaxScanBytes", "IsExactAggregate", });
          internal_static_CubeVisitRequest_IntList_descriptor =
          ...
          internal_static_CubeVisitResponse_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_CubeVisitResponse_descriptor,
              new String[] { "CompressedRows", "Stats", "ErrorInfo", });
          internal_static_CubeVisitResponse_Stats_descriptor =
          ...
          internal_static_CubeVisitResponse_Stats_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_CubeVisitResponse_Stats_descriptor,
              new String[] { "ServiceStartTime", "ServiceEndTime", "ScannedRowCount", "AggregatedRowCount", "SystemCpuLoad", "FreePhysicalMemorySize", "FreeSwapSpaceSize", "Hostname", "EtcMsg", "NormalComplete", "ScannedBytes", "FilteredRowCount", "CompressionTimeCost", });
          internal_static_CubeVisitResponse_ErrorInfo_descriptor =
