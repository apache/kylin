...
public class TrieDictionaryTest {
	...
	public static void main(String[] args) throws Exception {
		InputStream is = new FileInputStream(
				"src/test/resources/dict/dw_category_grouping_names.dat");
		// InputStream is =
	...
	public void englishWordsTest() throws Exception {
		InputStream is = new FileInputStream(
				"src/test/resources/dict/eng_com.dic");
		ArrayList<String> str = loadStrings(is);
		testStringDictionary(str, null);
	}
	...
	private static void benchmarkStringDictionary(ArrayList<String> str)
	...
	private static int benchmark(String msg, TrieDictionary<String> dict,
			TreeSet<String> set, HashMap<String, Integer> map,
			String[] strArray, byte[][] array) {
		int n = set.size();
	...
	private static TrieDictionary<String> testSerialize(
	...
	private static TrieDictionaryBuilder<String> newDictBuilder(
	...
	private static ArrayList<String> loadStrings(InputStream is)
			throws Exception {
