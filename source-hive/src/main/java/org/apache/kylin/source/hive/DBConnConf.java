    ...
    private static String filterUrl(String url) {
        if (url.contains("?")) {
            if (url.contains(ALLOW_LOAD_LOCAL_IN_FILE_NAME)) {
                url = url.replace(ALLOW_LOAD_LOCAL_IN_FILE_NAME, "");
            }
            if (url.contains(AUTO_DESERIALIZE)) {
                url = url.replace(AUTO_DESERIALIZE, "");
            }
            if (url.contains(ALLOW_LOCAL_IN_FILE_NAME)) {
                url = url.replace(ALLOW_LOCAL_IN_FILE_NAME, "");
            }
            if (url.contains(ALLOW_URL_IN_LOCAL_IN_FILE_NAME)) {
                url = url.replace(ALLOW_URL_IN_LOCAL_IN_FILE_NAME, "");
            }
        } else {
