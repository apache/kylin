...
public class KafkaFlatTableMapper extends KylinMapper<LongWritable, BytesWritable, BytesWritable, Text> {
    ...
    protected void doSetup(Context context) throws IOException {
        ...
        final StreamCubeJoinedFlatTableDesc streamFlatTableDesc = new StreamCubeJoinedFlatTableDesc(cubeSegment, flatTableDesc);

        final List<TblColRef> allColumns = streamFlatTableDesc.getAllColumns();
