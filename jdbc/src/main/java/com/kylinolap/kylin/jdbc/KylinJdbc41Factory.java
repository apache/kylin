...
public class KylinJdbc41Factory implements AvaticaFactory {
	...
	public AvaticaStatement newStatement(AvaticaConnection connection,
		...
		return new KylinJdbc41Statement(connection, resultSetType,
	...
	public AvaticaPreparedStatement newPreparedStatement(
		...
		return new KylinJdbc41PreparedStatement(connection, prepareResult,
	...
	public AvaticaResultSet newResultSet(AvaticaStatement statement,
		...
		final ResultSetMetaData metaData = newResultSetMetaData(statement,
				prepareResult.getColumnList());
		return new KylinResultSet(statement, prepareResult, metaData, timeZone);
	}

	public AvaticaResultSetMetaData newResultSetMetaData(
			AvaticaStatement statement, List<ColumnMetaData> columnMetaDataList) {
	...
	private static class KylinJdbc41Connection extends KylinConnectionImpl {
		KylinJdbc41Connection(UnregisteredDriver driver,
				AvaticaFactory factory, String url, Properties info) {
	...
	public static class KylinJdbc41Statement extends KylinStatementImpl {
		public KylinJdbc41Statement(AvaticaConnection connection,
				int resultSetType, int resultSetConcurrency,
				int resultSetHoldability) {
	...
	public static class KylinJdbc41PreparedStatement extends
			KylinPrepareStatementImpl {
		KylinJdbc41PreparedStatement(AvaticaConnection connection,
				AvaticaPrepareResult sql, int resultSetType,
	...
	private static class AvaticaJdbc41DatabaseMetaData extends
