...
public class JobService extends BasicService {
    ...
    public String submitJob(CubeInstance cube, long startDate, long endDate, RealizationBuildTypeEnum buildType, String submitter) throws IOException, JobException, InvalidJobInstanceException {
