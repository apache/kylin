...
public class LookupTableTest extends LocalFileMetadataTestCase {
    ...
    public void testBasic() throws Exception {
        ...
        lookup = new LookupBytesTable(siteTable, new String[] { "SITE_ID" }, new FileTable(this.testDataFolder + "/data/TEST_SITES.csv", 10));
        lookup.dump();

        System.out.println("============================================================================");

        lookup = new LookupBytesTable(categoryTable, new String[] { "leaf_categ_id", "site_id" }, new FileTable(this.testDataFolder + "/data/TEST_CATEGORY_GROUPINGS.csv", 36));
        lookup.dump();
