...
public class HBaseConnection {
    ...
    /**
     * for minicluster test case to invert Configuration generated by HBaseTestingUtility
     */
    public static void putConfig(String url, Configuration conf) {
        ConfigCache.put(url, conf);
    }
