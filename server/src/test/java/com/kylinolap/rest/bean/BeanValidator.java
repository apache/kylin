...
public class BeanValidator {
	 ...
	 */
	public static <T> void validateAccssor(final Class<T> clazz,
				...
				if (params.length == 1 && params[0] == returnType) {
					try {
						...
						Assert.assertEquals(String.format(
								...
								prop.getName()), value, getter.invoke(bean));
	...
	private static Object buildValue(Class<?> clazz)
		...
		if (clazz.isArray()) {
			...
			return Proxy.newProxyInstance(clazz.getClassLoader(),
					...
					new java.lang.reflect.InvocationHandler() {
						...
						public Object invoke(Object proxy, Method method,
							...
							if (Object.class.getMethod("equals", Object.class)
									.equals(method)) {
								return proxy == args[0];
							}
							if (Object.class
									.getMethod("hashCode", Object.class)
									.equals(method)) {
								return Integer.valueOf(System
										.identityHashCode(proxy));
							}
							if (Object.class
									.getMethod("toString", Object.class)
									.equals(method)) {
			...
			System.err.println("Unable to build an instance of class "
					+ clazz.getName() + ", please add some code to the "
					+ BeanValidator.class.getName() + " class to do this.");
			return null;
		}
	}
